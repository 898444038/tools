...
import com.ming.tools.generate.old.annotation.Transient;
import com.ming.tools.generate.old.entity.ClassField;
...
public class GenerateUtil {
    ...
    public static List<ClassField> getFieldList(Class clazz){
        ...
        for (Field field : fields){
            ...
            if(field.isAnnotationPresent(com.ming.tools.generate.old.annotation.Comment.class)){
                com.ming.tools.generate.old.annotation.Comment comment = (com.ming.tools.generate.old.annotation.Comment)field.getAnnotation(com.ming.tools.generate.old.annotation.Comment.class);
