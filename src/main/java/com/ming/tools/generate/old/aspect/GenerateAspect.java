package com.ming.tools.generate.old.aspect;

import com.ming.tools.generate.old.Generate;
import com.ming.tools.generate.old.annotation.GenerateScan;
...
public class GenerateAspect {
    ...
    @Pointcut("execution(* *(..)) && @within(com.ming.tools.generate.old.annotation.GenerateScan)")
    private void point(){}
